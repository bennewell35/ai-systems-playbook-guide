...
const Footer = () => (
  <footer className="border-t py-8 bg-white text-center text-gray-500 mt-14">
    <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 px-4">
      ...
      <div className="flex items-center gap-4 mt-2 md:mt-0">
        <a href="https://www.linkedin.com/in/jonathan-newell/" target="_blank" rel="noopener noreferrer">
          <Linkedin size={20} className="text-primary hover:text-accent transition" />
        </a>
