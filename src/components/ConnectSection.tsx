      ...
      <div className="flex-1 flex flex-col justify-center items-start mb-8 md:mb-0">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
          <Button
            asChild
            variant="outline"
            className="bg-white text-accent font-semibold rounded-[12px] px-6 py-3 shadow hover:bg-gray-100 transition-colors text-lg mb-0 w-full sm:w-auto flex items-center justify-center"
          >
            <a href="mailto:newelljben@gmail.com" className="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24"><path fill="currentColor" d="M2.25 6.5A2.25 2.25 0 0 1 4.5 4.25h15A2.25 2.25 0 0 1 21.75 6.5v11a2.25 2.25 0 0 1-2.25 2.25h-15A2.25 2.25 0 0 1 2.25 17.5v-11Zm1.5.342V17.5a.75.75 0 0 0 .75.75h15a.75.75 0 0 0 .75-.75V6.842l-7.644 6.574a1.75 1.75 0 0 1-2.112 0L3.75 6.842ZM4.34 5.75l7.667 6.6a.25.25 0 0 0 .313 0l7.666-6.6a.75.75 0 0 0-.486-.25h-15a.75.75 0 0 0-.486.25Z"></path></svg>
              Email Me
            </a>
          </Button>
          <Button
            asChild
            variant="default"
            className="bg-primary text-white font-semibold rounded-[12px] px-6 py-3 shadow hover:bg-primary/90 transition-colors text-lg mb-0 w-full sm:w-auto flex items-center justify-center"
          >
            <a
          ...
          <Button
            asChild
            variant="ghost"
            className="bg-gray-900 text-white font-semibold rounded-[12px] px-6 py-3 shadow hover:bg-gray-800 transition-colors text-lg mb-0 w-full sm:w-auto flex items-center justify-center"
          >
            <a
